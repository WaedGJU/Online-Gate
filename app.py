...
with header_col2:
    st.markdown("<h1 style='margin-top: 3rem; margin-bottom: -10px; padding-top: 0rem; color: #706f6f;'>Online Gate project Dashboard-1st Semester </h1>", unsafe_allow_html=True)
