...
# 2. تحديد المسار والروابط (استبدل SHEET_ID بالمعرف الخاص بك)
...
with header_col2:
    st.markdown("<h1 style='margin-top: 1.5rem; margin-bottom: -10px; padding-top: 0rem; color: #706f6f;'>Online Gate Development Dashboard</h1>", unsafe_allow_html=True)

st.markdown("<hr style='margin-top: 5px; margin-bottom: 15px;'>", unsafe_allow_html=True)

# --- 7. قسم الـ Metrics (تمت إضافة الموعد النهائي) ---
